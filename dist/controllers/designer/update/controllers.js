...
exports.UpdateComponentUI = void 0;
...
const UpdateComponentUI = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        try {
        ...
        for (let i = 0; i < ((_a = data === null || data === void 0 ? void 0 : data.children) === null || _a === void 0 ? void 0 : _a.length); i++) {
            let command = `g.V().hasId('${maincomponentid}').as('a').V().hasId('${data === null || data === void 0 ? void 0 : data.children[i]}').as('b').addE('contains').from('a').to('b')`;
        ...
        for (let i = 0; i < ((_b = data === null || data === void 0 ? void 0 : data.removechildren) === null || _b === void 0 ? void 0 : _b.length); i++) {
            let command = `g.V().hasId('${maincomponentid}').outE('contains').where(inV().hasId('${data === null || data === void 0 ? void 0 : data.removechildren[i]}')).drop()
      `;
            yield axios_1.default
                .post(`${process.env.COMMAND_ENDPOINT}`, {
                command: command,
...
exports.UpdateComponentUI = UpdateComponentUI;
