...
exports.GetComponentDetailsWithChildren = exports.GetComponentById = exports.GetScenes = exports.GetOrganizations = exports.GetSites = exports.GetGuardianServers = exports.GetEnvironments = exports.GetHierarchyUI = exports.GetHierarchyIOT = exports.GetHierarchy = void 0;
...
const GetHierarchy = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const authHeader = yield (0, generateAuthorizationHeader_1.GenerateAuthorizationHeader)(`${process.env.USERNAME}`, `${process.env.PASSWORD}`);
        let tree = {};
        let nodes = [];
        try {
...
const GetComponentDetailsWithChildren = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        try {
            validators_1.VertexId.parse(req.query.componentid);
        }
...
exports.GetComponentDetailsWithChildren = GetComponentDetailsWithChildren;
